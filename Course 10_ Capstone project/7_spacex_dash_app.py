...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df,
                    names='class',  
                    title='Launch Outcome of Site ' + entered_site
                    )
    return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y= 'class',
                        ...
                        title= 'Landing Outcome vs. Payload Mass for All Sites'
                    )
    else: # return chart for a selected site
        filtered_df = filtered_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y= 'class',
                        color= 'Booster Version Category',
                        title= 'Landing Outcome vs. Payload Mass for Site ' + entered_site
                    )
    return fig
